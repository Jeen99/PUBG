...
{
	public class Bot : GameObject, IPlayer
	{
		...
		public Bot(IModelForComponents context, PointF location) : base(context)
		{
			#region CreateShape
			...
			var ai = new AI(this);
			Components.Add(ai);
			//временное решение, нужно будет переделать добавление оружия
			collector.AddWeapon(new Gun(context, new PointF(0,0)));
		}
